...
const CATEGORY_RULE_DEFINITIONS = {
  ...
  'Cloud/Infra': {
    hosts: [
      ...
      ['Oracle Cloud Console', 'console.oraclecloud.com'],
      ...
      ['Linode Docs', 'linode.com'],
      ['Vultr', 'my.vultr.com'],
      ['Vultr Docs', 'vultr.com'],
      ['OVHcloud', 'ovh.com'],
      ['OVHcloud Docs', 'docs.ovh.com'],
      ['Netlify', 'app.netlify.com'],
      ['Netlify Docs', 'docs.netlify.com'],
      ['Fastly', 'manage.fastly.com'],
      ['Fastly Docs', 'docs.fastly.com'],
      ['Akamai Control Center', 'control.akamai.com'],
      ['Akamai TechDocs', 'techdocs.akamai.com'],
      ...
      ['Google Cloud Blog', 'cloud.googleblog.com'],
      ['Google Cloud Skills Boost', 'cloudskillsboost.google'],
      ['Red Hat OpenShift', 'cloud.redhat.com'],
      ['Red Hat', 'redhat.com'],
      ['VMware', 'vmware.com'],
      ['F5', 'f5.com'],
      ['Zscaler', 'zscaler.com'],
      ...
      ['Torq', 'torq.io'],
      ['Sentra', 'sentra.io'],
      ['Satori', 'satoricyber.com'],
      ['Tufin', 'tufin.com'],
      ['Cyberint', 'cyberint.com'],
      ['Skyhawk Security', 'skyhawk.security'],
      ['Laminar Security', 'laminarsecurity.com'],
      ['Lightspin', 'lightspin.io'],
      ['Ermetic', 'ermetic.com'],
      ['Varonis', 'varonis.com'],
      ['Imperva', 'imperva.com'],
      ['Guardicore', 'guardicore.com'],
      ['Skybox Security', 'skyboxsecurity.com'],
      ['XM Cyber', 'xmcyber.com'],
      ['Pentera', 'pentera.io'],
      ['Panoptica', 'panoptica.app'],
      ['Bridgecrew', 'bridgecrew.cloud'],
      ['Akeyless', 'akeyless.io'],
      ['Cider Security', 'cidersecurity.io'],
      ['Apiiro', 'apiiro.com'],
      ['Hunters', 'hunters.ai'],
      ['Cynet', 'cynet.com'],
      ['Astrix Security', 'astrixsecurity.com'],
  ...
  'News/Media': {
    hosts: [
      ...
      ['Israel21c', 'israel21c.org'],
      ['Channel 13 News', '13news.co.il'],
      ['Channel 14 News', 'now14.co.il'],
      ['Yedioth Ahronoth', 'yediot.co.il'],
      ['Bizportal', 'bizportal.co.il']
    ],
    hostRegexes: [
      ['MSN News', '^(?:www\\.)?msn\\.com$'],
      ['Google News', '^news\\.google\\.[a-z.]+$'],
      ['Yahoo News', '^news\\.yahoo\\.[a-z.]+$']
    ]
  }
};
...
const CATEGORY_KEYWORD_DEFINITIONS = {
  ...
  'News/Media': {
    ...
    titleHints: ['breaking', 'episode', 'season', 'tweet', 'timeline', 'top stories?', 'live (?:update|blog)'],
    threshold: 3
  }
};
